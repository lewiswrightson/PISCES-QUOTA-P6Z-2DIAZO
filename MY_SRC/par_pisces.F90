MODULE par_pisces
   ...
   INTEGER, PUBLIC ::   jpccr     !: Diazotroph2 carbon concentration
   INTEGER, PUBLIC ::   jpfec     !: Diazotroph2 iron concentration
   INTEGER, PUBLIC ::   jpchc     !: Diazotroph2 chlorophyll concentration
   INTEGER, PUBLIC ::   jpncr     !: Diazotroph2 nitrogen concentration
   INTEGER, PUBLIC ::   jppcr     !: Diazotroph2 phosphorus concentration
   !!---------------------------------------------------------------------
